...
def pr_body(document: RenderedDocument, mdx: MDXDocument, *, generated_at: datetime) -> str:
    ...
    lines += [
        ...
        "",
        "Generated by the competitor-analysis agent (Gemini article generation, fact-checked "
        "and scored by its quality gates, approved before publication). The author byline is "
        "the configured team byline.",
        "",
